...
void func_pro::set_B_op(vector<vector<ZZ>* >* B, vector<vector<vector<long>* >* >* basis_B,
 vector<vector<ZZ>* >* chal_x2,vector<vector<vector<long>* >*>* pi, long omega_mulex){
	long i,j;
	long row, col;
	vector<ZZ>* r =0;
...
void func_pro::set_B(vector<vector<ZZ>* >* B, vector<vector<ZZ>* >* chal_x2, 
