...
func GeDoubleScalarMultVartime2(r3 *ExtendedGroupElement, a *Key, A *ExtendedGroupElement, b *Key) {
...
// where Bi is the [8]CachedGroupElement consisting of
// B,3B,5B,7B,9B,11B,13B,15B
func GeDoubleScalarMultPrecompVartime2_p3(r3 *ExtendedGroupElement, a *Key, Ai *[8]CachedGroupElement, b *Key, Bi *[8]CachedGroupElement) {
	var aSlide, bSlide [256]int8
	//var Ai [8]CachedGroupElement // A,3A,5A,7A,9A,11A,13A,15A
	var t CompletedGroupElement
	var u ExtendedGroupElement
